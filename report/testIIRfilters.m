...
for k=1:10
    ...
    w\textunderscore 0=k*base\textunderscore f
    ...
    h\textunderscore 0\textunderscore outputs(k,1:100)=ccde(input\textunderscore signal, output\textunderscore signal\textunderscore 0, numerator\textunderscore d\textunderscore lp,denominator\textunderscore d\textunderscore lp);
    h\textunderscore 1\textunderscore outputs(k,1:100)=ccde(input\textunderscore signal, output\textunderscore signal\textunderscore 1, numerator\textunderscore d\textunderscore hp,denominator\textunderscore d\textunderscore hp);
    input\textunderscore signals(k,1:100)=input\textunderscore signal;
end
...
delay=finddelay(input\textunderscore signal, h\textunderscore 0\textunderscore outputs(1,:));
...
for i = 40:100
    ...
    MSE\textunderscore lp=MSE\textunderscore lp+(cos(pi/10*(i-delay-matlabIndexOffset))-h\textunderscore 0\textunderscore outputs(1,i))^2;
    ideal\textunderscore val\textunderscore squared=ideal\textunderscore val\textunderscore squared+(cos(pi/10*(i-delay-matlabIndexOffset)))^2;
end
...
for i = 40:100
    MSE\textunderscore lp2=MSE\textunderscore lp2+(0.05*cos(pi*(i-delay-matlabIndexOffset))-h\textunderscore 0\textunderscore outputs(10,i))^2;
    ideal\textunderscore val\textunderscore squared2=ideal\textunderscore val\textunderscore squared2+0.00025*(cos(pi*(i-delay-matlabIndexOffset)))^2;
end
...
delay=finddelay(input\textunderscore signal, h\textunderscore 0\textunderscore outputs(3,:));
...
for i = 40:100
    ...
    ideal\textunderscore val\textunderscore squared2=ideal\textunderscore val\textunderscore squared2+0.00025*(cos(pi/10*(i-delay-matlabIndexOffset)))^2;
end

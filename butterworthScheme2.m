...
[numerator_d_lp,denominator_d_lp]=bilinear(numerator,denominator,1);
...
[numerator_d_hp, denominator_d_hp]=butter(14,1.89077219/pi,'high');

figure(3)
freqz(numerator_d_hp, denominator_d_hp);
